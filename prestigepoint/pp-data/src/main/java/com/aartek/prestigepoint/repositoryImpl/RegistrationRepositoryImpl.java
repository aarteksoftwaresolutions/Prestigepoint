...
public class RegistrationRepositoryImpl implements RegistrationRepository {
  ...
  public List<Registration> getAllStudentDetails() {
    ...
    studentList = hibernateTemplate.find("from Registration  where IS_DELETED=" + IConstant.IS_DELETED +"order by registrationId desc");
    return studentList;
  }

  public List<Registration> getStudentDetailsByName(String firstName) {
	    List<Registration> studentList = null;
	    studentList = hibernateTemplate.find("from Registration r  where  r.firstName='"+firstName+"' or  r.firstName LIKE '%"+firstName+"%' and  r.isDeleted=" + IConstant.IS_DELETED +" order by registrationId desc");
	    return studentList;
	  }  
  ...
  public List<String> getallStudentEmailId() {
    ...
    emailList = hibernateTemplate
        .find("select r.emailId from Registration r where r.isDeleted=" + IConstant.IS_DELETED);
    return emailList;
  }
