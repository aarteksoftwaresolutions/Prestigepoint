...
public class UploadImagesRepositoryImpI implements UploadImagesRepository {
	...
	public List<UploadImages> getAllStudentName() {
		List<UploadImages> uploadImagesList = hibernateTemplate.find("from UploadImages where IS_DELETED="+ IConstant.IS_DELETED);
		return uploadImagesList;
		
	}

	public List<UploadImages> editUploadImagesStatus(Integer imagesId) {
		List<UploadImages> uploadImagesList = hibernateTemplate.find("from UploadImages a where a.imagesId=" + imagesId);
		return  uploadImagesList;
	}
