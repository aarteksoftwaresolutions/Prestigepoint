...
public class SendMail {
    ...
    public static void emiMail(String emailId, Integer submittedFee, String firstName, Integer totalFee,
    ...
    public static void editEmiMail(String emailId, Integer submittedFee, String firstName, Integer totalFee,
                    Integer amount, String date) {
              Session session = SendMailProperty.mailProperty();
     ...
     * 
     * final String username = IConstant.FROM_EMAIL_ID; final String password =
     * IConstant.FROM_PASSWORD; Properties props = new Properties();
     ...
     * ,"javax.net.ssl.SSLSocketFactory"); Session session =
     ...
     * PasswordAuthentication(username, password); } }); try { Message message =
     * new MimeMessage(session); message.setFrom(new
     * InternetAddress(IConstant.FROM_EMAIL_ID));
     * message.setRecipients(Message.RecipientType.TO,
     * InternetAddress.parse("sumitgangrade1006@gmail.com"));
     * message.setSubject("Regards:Forgot password");
     * 
     * message.setContent("Hiiii test mail", "text/html");
     * Transport.send(message); System.out.println("Done"); } catch
