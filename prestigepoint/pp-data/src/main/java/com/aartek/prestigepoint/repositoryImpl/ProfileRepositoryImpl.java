...
public class ProfileRepositoryImpl implements ProfileRepository {
  ...
  public List<Registration> getStudentDetails(int registrationId) {
    ...
    list = hibernateTemplate.find("from Registration r where r.registrationId=" + registrationId + " and r.isDeleted="
  ...
  public boolean updateProfile(Registration registration) {
    if (registration != null) {
      Registration registration1 = (Registration) hibernateTemplate.get(Registration.class, registration.getRegistrationId());
