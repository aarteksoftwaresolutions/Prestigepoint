...
public class MarqueeController {
	...
	private String addChallenge(Map<String, Object> map, @RequestParam(required = false) String message, ModelMap model) {
	...
	public String deleteMarqueeDescription(@RequestParam(required = false) Integer  marqueeId,ModelMap model) {
		addMarqueeService.deleteMarqueeDescription( marqueeId);
