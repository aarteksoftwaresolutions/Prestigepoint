...
<body>
	<div class="container clearfix">
		<div class="conact-form">
			...
			<display:table name="questionAnswerList" pagesize="12" class="basic-table" uid="quesion" requestURI="questionAndAnswer.do">
     ...
     ${count}
				...
				<display:column title="Delete">
					 <a href="deleteQuestionAnswer.do?questionId=${quesion.questionId}"
