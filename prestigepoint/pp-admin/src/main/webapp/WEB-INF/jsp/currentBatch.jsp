...
<body>
  <div class="container clearfix">
    <div class="conact-form">
      ...
      <form:form method="POST" action="addCurrentBatch.do" modelAttribute="CurrentBatch" autocomplete="off">
        <table width="100%" border="0">
          <tr>
            <td><div class="form-control">
                ...
                <label>
                  <p>
                  <h3 style="color: #873d80;">Add Current Batch</h3> <small class="required"></small>
                  </p> </label> <label>
                  <p>
                    Batch<small class="required">*</small>
                  </p> <form:input path="batchName" class="inputControl1" placeholder="Current Topic" required="autofocus"
                    maxlength="40" /></label>
          ...
          <tr>
            <td><div class="form-control">
                ...
                <label>
                  ...
                  <form:select path="status" class="inputControl1">
                    <form:option value="0" label="Select" />
                    <form:option value="open" label="Registration Open" />
                    <form:option value="close" label="Registration Close" />
                  </form:select> </label>
              </div></td>
          </tr>
            <tr>
            <td><div class="form-control">
                ...
                <label>
                  ...
                  <form:input path="currentTopic" class="inputControl1" placeholder="Current Topic" required="autofocus"
                    maxlength="40" /> </label>
              </div></td>
          </tr>
          <tr>
            <td><div class="form-control">
                ...
                <label>
                  ...
                  </p> <form:input path="onOfStudent" class="inputControl1" placeholder="No of Student" required="autofocus"
                    maxlength="5" /> </label>
              </div></td>
          </tr>
          <tr>
      ...
      <display:table name="currentBatchList" pagesize="8" class="basic-table" uid="cbl" requestURI="currentBatch.do">
     ...
     ${count}
        ...
        <display:column title="Delete">
          <a href="deleteCurrentBatch.do?currentBatchId=${cbl.currentBatchId}"
