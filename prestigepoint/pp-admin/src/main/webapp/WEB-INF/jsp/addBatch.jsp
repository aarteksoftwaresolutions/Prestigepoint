        ...
        <table width="100%" border="0">
          <tr>
            <td><div class="form-control">
                ...
                <label>
                  <p>
                  <h3 style="color: #873d80;">Add Batch</h3> <small class="required"></small>
                  </p>
                </label> <label>
                  <p>
                    Batch Name<small class="required"></small>
                  </p> <form:input path="batchName" class="inputControl1" placeholder="Batch Name" required="autofocus"
                    maxlength="50" /> <form:hidden path="batchId" />
                </label>
              </div></td>
          </tr>
          <tr>
            <td><div class="form-control">
                ...
                <label>
                  ...
                  </p> <form:input path="startDate" id="datepick" class="inputControl1" placeholder="Start Date"
