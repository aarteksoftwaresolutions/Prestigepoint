        ...
        <table width="100%" border="0">
          <tr>
            <td><div class="form-control">
                ...
                <label>
                  <p>
                  <h3 style="color: #873d80;">Add Courses</h3>
          ...
          <tr>
            <td><div class="form-control">
                ...
                <label>
                  ...
                  </p> <form:input path="courseFee" class="inputControl1" placeholder="Course Fee" required="autofocus"
                    maxlength="6" onkeypress="return onlyNos(event,this);" /> </label>
              </div>
            </td>
          </tr>
          <tr>
