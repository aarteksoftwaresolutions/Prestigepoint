...
public class UploadImagesServiceImpI implements UploadImagesService {
		...
		if (uploadImages != null) {
			...
			if (uploadImages1 != null) {
				...
				if (newImg != null) {
					...
					uploadImages.setNameOfimages(uploadImages.getImagesId()
							+ ".png");
	...
	public List<UploadImages> getAllUploadImages() {
		List<UploadImages> list = new ArrayList<UploadImages>();
		list = uploadImagesRepository.getAllStudentName();
		return list;
	}
	...
	public void changeUploadImagesStatus(String uploadImageIdValue, Integer uploadImageValue) {
		if (uploadImageIdValue != null && uploadImageValue != null) {
			UploadImages uploadImages = (UploadImages) uploadImagesRepository.editUploadImagesStatus(uploadImageValue).get(0);
