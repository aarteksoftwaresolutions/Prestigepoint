...
public class UploadPlacedStudentImagesServiceImpl implements UploadPlacedStudentImagesService {
	...
	public boolean savePlacedStudentImages(UploadPlacedStudentImages uploadPlacedStudentImages) {
		...
		if (uploadPlacedStudentImages != null) {
			UploadPlacedStudentImages UploadPlacedStudentImage = uploadPlacedStudentImagesRepository.savePlacedStudentImages(uploadPlacedStudentImages);
			if (UploadPlacedStudentImage != null) {
				BufferedImage newImg;
				String imageData = UploadPlacedStudentImage.getUploadPlacedStudentImagesPath().replaceFirst("^data:image/[^;]*;base64,?", "");
				...
				if (newImg != null) {
					...
					UploadPlacedStudentImage.setNameOfStudentImages(UploadPlacedStudentImage.getStudentImagesId() + ".png");
	...
	public List<UploadPlacedStudentImages> getAllPlacedStudentImages()throws IOException {
			List<UploadPlacedStudentImages> studentImagesList = uploadPlacedStudentImagesRepository.getAllPlacedStudentImages();
